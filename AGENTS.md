...
Este é o repositório de **conteúdo** do Data Labs (Caramelo Tech):

- **Conteúdo:** 100% em `notes/`, Markdown puro em português brasileiro, sem frontmatter
- **Publicação:** o repositório hub [labs](https://github.com/caramelotech/labs) busca as notas daqui e publica em `https://caramelotech.com.br/labs/data/`
...
Exemplo de nota nova (`notes/fundamentos/04-sql.md`):
...
- Links para outras notas do site: caminho completo `/labs/data/<secao>/<nota>/`
